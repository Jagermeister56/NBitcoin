...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        protected override NetworkBuilder CreateMainnet()
        {
            ...
            .AddDNSSeeds(new[]
            {
				new DNSSeedData("btcz.rocks", "btcz.kovach.biz"),
				new DNSSeedData("btcz.rocks", "seed.btcz.life"),
				new DNSSeedData("btcz.rocks", "bzseed.secnode.tk"),
				new DNSSeedData("btcz.rocks", "btzseed.blockhub.info"),
				new DNSSeedData("btcz.rocks", "btczseed.1ds.us"),
				new DNSSeedData("btcz.rocks", "104.131.83.192"),
				new DNSSeedData("btcz.rocks", "52.207.253.9"),
				new DNSSeedData("btcz.rocks", "54.174.68.212"),
				new DNSSeedData("btcz.rocks", "155.138.144.191:1989"),
				new DNSSeedData("btcz.rocks", "107.191.52.3:1989"),
				new DNSSeedData("btcz.rocks", "207.246.92.95:1989"),
				new DNSSeedData("btcz.rocks", "144.202.51.98:1989")
            })
